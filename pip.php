...
// query table PIP
$queryPIP = query("SELECT * FROM tb_pip");
...
<head>
	...
	<title>Data Pakta Integritas Perorangan - SiKuDa BaJa</title>
...
<body>
	<div class="wrapper">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Pakta Integritas Perorangan</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Data Pakta Integritas Perorangan</a>
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="add-pip" class="btn bg-skb-3 text-white btn-round"><i class="fa fa-plus"></i> Buat PIP</a>
										<h4 class="card-title ml-auto"><?php echo "{$resultPIP["jmlhPIP"]}"; ?> Data PIP</h4>
									</div>
								</div>
								<div class="card-body">
															...
															<div class="form-button-action">
																<div class="dropdown show">
																	...
																	<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																		<a class="dropdown-item text-light bg-skb-3" href="edit-pip?id_pip=<?= $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>

																		<form action="print-word" method="post">
																			<input type="text" hidden name="nama" value="<?= $row["nama"]; ?>">
																			<input type="text" hidden name="no_identitas" value="<?= $row["no_identitas"]; ?>">
																			<input type="text" hidden name="alamat_ktp" value="<?= $row["alamat_ktp"]; ?>">
																			<input type="text" hidden name="pekerjaan" value="<?= $row["pekerjaan"]; ?>">
																		...
																		<a class="dropdown-item text-light bg-skb-6" href="#" data-toggle="modal" data-target="#delete-pip<?= $row["id"]; ?>"><i class=" fa fa-trash"></i> Hapus</a>
		...
		<!-- Modal Delete Memo -->
		<?php foreach ($queryPIP as $row) : ?>
			<div class="modal fade" id="delete-pip<?= $row["id"]; ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLongTitle">Hapus PIP?</h5>
						...
						<div class="modal-footer">
							...
							<a href="delete-pip?id_del_pip=<?= $row["id"]; ?>" type="button" class="btn bg-skb-1 text-white">Hapus</a>
						</div>
					</div>
				</div>
			</div>
